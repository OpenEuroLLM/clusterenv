...
echo -e "  ${CYAN}OELLM_PROJECT_ROOT${NC}=${GREEN}$OELLM_PROJECT_ROOT${NC}"
echo -e "  ${CYAN}OELLM_EVAL_DIR${NC}=${GREEN}$OELLM_EVAL_DIR${NC}"
echo -e "  ${CYAN}OELLM_CONTAINERS_DIR${NC}=${GREEN}$OELLM_CONTAINERS_DIR${NC}"
echo -e "  ${CYAN}OELLM_CHECKPOINTS_PRETRAIN_DIR${NC}=${GREEN}$OELLM_CHECKPOINTS_PRETRAIN_DIR${NC}"
echo -e "  ${CYAN}OELLM_CHECKPOINTS_POSTTRAIN_DIR${NC}=${GREEN}$OELLM_CHECKPOINTS_POSTTRAIN_DIR${NC}"
echo -e "  ${CYAN}OELLM_DATASETS_RAW_DIR${NC}=${GREEN}$OELLM_DATASETS_RAW_DIR${NC}"
echo -e "  ${CYAN}OELLM_DATASETS_TOKENIZED_DIR${NC}=${GREEN}$OELLM_DATASETS_TOKENIZED_DIR${NC}"
echo -e "  ${CYAN}HF_HOME${NC}=${GREEN}$HF_HOME${NC}"
echo -e "  ${CYAN}OELLM_WANDB_DIR${NC}=${GREEN}$OELLM_WANDB_DIR${NC}"
echo -e "  ${CYAN}WANDB_PROJECT${NC}=${GREEN}$WANDB_PROJECT${NC}"
echo -e "  ${CYAN}OELLM_SLURM_JOBS_DIR${NC}=${GREEN}$OELLM_SLURM_JOBS_DIR${NC}"
